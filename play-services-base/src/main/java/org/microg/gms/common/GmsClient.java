...
public abstract class GmsClient<I extends IInterface> implements Api.Client {
    ...
    protected boolean allowUserMicrog;
    ...
    public synchronized void connect() {
        ...
        if (!MultiConnectionKeeper.getInstance(context).bind(actionString, serviceConnection, requireMicrog, allowUserMicrog)) {
